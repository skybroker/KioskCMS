...
<th width="13%" class="Right">联系人</th>
<th width="16%" class="Right">联系电话</th>
<th width="18%" class="Right">邮箱</th>
<th width="18%" class="Right">留言时间</th>
...
<th width="10%" class="Right">管理操作</th>
</tr>
<%
...
<td class="Right"><a href="LookGuestBook.asp?ID=<%=Rs("ID")%>&Page=<%=Page%>&ParentID=<%=ID%>"><%=Rs("UserName")%></a></td>
<td class="Right"><%=Rs("LinkPhone")%></td>
<td class="Right"><%=Rs("Email")%>&nbsp;</td>
...
%>
<tr>
<th colspan="3" style="font-weight:normal">操作：&nbsp;<a href="javascript:Delete();" style="font-weight:normal">删除</a></th>
