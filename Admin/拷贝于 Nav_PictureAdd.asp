...
<tr>
<td class="Right" width="25%" align="right">图片内容名称：</td>
<td width="75%" colspan="3"><input type="text" id="NavTitle" name="NavTitle" value="" class="Input300px"/></td>
</tr>
<tr>
<td class="Right" width="25%" align="right">图片内容说明：</td>
<td width="75%" colspan="3"><input type="text" id="NavRemark" name="NavRemark" value="" class="Input300px"/></td>
</tr>
<tr>
<td class="Right" width="25%" align="right">图片内容图片：</td>
