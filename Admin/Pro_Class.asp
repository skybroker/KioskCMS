...
<tr>
<td style="border-bottom:solid 1px #dde4e9;height:30px;width:80%">当前位置：<a href="Pro_Class.asp">产品类别维护</a><%=GetNavPath("ShopClass",ID)%></td>
<td style="border-bottom:solid 1px #dde4e9;height:30px;width:20%; text-align:right"><a href="Pro_ClassAdd.asp?ID=<%=ID%>">添加产品类别</a>&nbsp;</td>
</tr>
<tr>
...
<td width="90%" valign="top">以下为所有产品类别的信息列表。<br>
...
<th width="29%" class="Right">类别名称<a href="Pro_ClassAdd.asp?ID=<%=ID%>">[+]</a></th>
<th width="36%" class="Right">类别说明</th>
...
<td class="Right"><a href="Pro_ClassEdit.asp?ID=<%=Rs("ID")%>&Page=<%=Page%>&ParentID=<%=ID%>"><%=Rs("NavTitle")%></a></td>
