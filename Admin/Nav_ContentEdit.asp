...
If Action="Save" Then
	...
	Sql="Select * From SiteNav Where ID="&ID&""
	...
	Conn.Close
	Set Conn=Nothing
	Response.Write("<script>alert('\u5bfc\u822a\u6761\u4fe1\u606f\u4fee\u6539\u64cd\u4f5c\u6210\u529f\u3002');window.location.href='Nav_Content.asp?Page="&Page&"&ID="&ParentID&"';</script>")
	Response.End()
End If
%>
...
<tr>
<td style="border-bottom:solid 1px #dde4e9;height:30px;width:80%">当前位置：<a href="Nav_Content.asp">导航条内容维护</a> >> 编辑导航条</td>
...
<tr>
<th class="Right" colspan="2">添加导航条</th>
</tr>
<tr>
...
<td width="75%"><input type="text" id="NavURL" name="NavURL" value="<%=NavURL%>" class="Input300px"/></td>
</tr>
<tr>
...
<option value=""<%If NavTarget="" Then Response.Write(" selected=""selected""")%>>原窗口</option>
<option value="_blank"<%If NavTarget="_blank" Then Response.Write(" selected=""selected""")%>>新窗口</option>
</select>
</td>
</tr>
<tr>
...
<td width="75%"><input type="submit" value="保 存" class="Button"> <input type="button" value="返 回" class="Button" onClick="window.location.href='Nav_Content.asp?ID=<%=ParentID%>&Page=<%=Page%>'"></td>
</tr>
</table>
</form>
</td>
