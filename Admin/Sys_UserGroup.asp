...
<tr>
  <td><div><input type="checkbox" id="CheckBox1" name="CheckBox1" value="mem_list"<%=ISPopedomCheck(UserName,"News")%>><b>会员管理</b></div>
<div class="float_left_25"><input type="checkbox" id="CheckBox1" name="CheckBox1" value="mem_ber"<%=ISPopedomCheck(UserName,"mem_ber")%>>会员查看</div>
<div class="float_left_25"><input type="checkbox" id="CheckBox1" name="CheckBox1" value="mem_list"<%=ISPopedomCheck(UserName,"mem_list")%>>会员管理</div></td>
</tr>
<tr>
<td>
...
<div class="float_left_25"><input type="checkbox" id="CheckBox1" name="CheckBox1" value="GuestBook_List"<%=ISPopedomCheck(UserName,"GuestBook")%>>访客留言</div>
</td>
</tr>
<tr>
