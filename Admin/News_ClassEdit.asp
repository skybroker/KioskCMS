...
If Action="Save" Then
	...
	Conn.Close
	Set Conn=Nothing
	Response.Write("<script>alert('\u7c7b\u522b\u540d\u79f0\u4fee\u6539\u64cd\u4f5c\u6210\u529f\u3002');window.location.href='News_Class.asp?Page="&Page&"&ID="&ParentID&"';</script>")
	Response.End()
End If
%>
...
<tr>
<th class="Right" colspan="2">编辑信息分类</th>
</tr>
<tr>
...
<td width="75%"><input type="submit" value="保 存" class="Button"> <input type="button" value="返 回" class="Button" onClick="window.location.href='News_Class.asp?ID=<%=ParentID%>&Page=<%=Page%>'"></td>
</tr>
</table>
</form>
</td>
