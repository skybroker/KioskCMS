...
If Action="Save" Then
	...
	Sql="Select NavOrder From SiteExplain Where NavParent="&ID&" Order By NavOrder Desc"
	...
	'获取导航条的深度值
	Set Rs=Server.CreateObject("Adodb.RecordSet")
	Sql="Select NavLevel From SiteExplain Where ID="&ID&""
	Rs.Open Sql,Conn,1,1
	If Not (Rs.Eof Or Rs.Bof) Then
...
<tr>
<th class="Right" colspan="2">添加说明页</th>
</tr>
<tr>
...
<td width="75%"><%=Editor("NavContent","")%><br /><span id="timemsg"></span><span id="msg2"></span><span id="msg"></span><script src="AutoSave.asp?Action=AutoSave&FrameName=NavContent"></script>
</td>
</tr>
<tr>
