...
Class Class_Upload
	...
	Private Sub Class_Initialize
		...
		m_TotalSize= 0
		m_MaxSize  = 30720000
		m_FileType = "jpg/gif/png/jpeg/bmp/rar/zip/pdf/doc/ppt/xls/swf/flv"
		m_SavePath = "/UploadFile/"&Year(dtmNow)&Right("0"&Month(dtmNow),2)&"/"
		m_AutoSave = 0
		...
		Set m_dicFSO  = Server.CreateObject("Scripting.FileSystemObject")
		'Response.write Server.MapPath(m_SavePath)
		'Response.end
		If m_dicFSO.FolderExists(Server.MapPath(m_SavePath)) = False Then
			m_dicFSO.CreateFolder Server.MapPath(m_SavePath)
		End If
